 ...
 /*
	...
	@WithMockUser(username = "Daryl_See", password = "azerty123", authorities = "HR_MANAGER")
 	public void testGEditProfile() throws Exception {
		...
		mockMvc.perform(multipart("/api/user/edit-profile").file(file).file(metadata).accept(MediaType.APPLICATION_JSON).with(new RequestPostProcessor() {
	        @Override
	...
	@Test
	@WithMockUser(username = "Roua_Boussetta", password = "azerty123", authorities = "ADMINISTRATOR")
 	public void testBFindUserLastName() throws Exception {
 		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/user/findUserLastname/LLC") 
				.accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON);
	...
	@Test
	@WithMockUser(username = "Roua_Boussetta", password = "azerty123", authorities = "ADMINISTRATOR")
 	public void testBFindUserByUsername() throws Exception {
 		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/user/findUserByUsername/NawaneraLLC") 
				.accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON);
	...
	@Test
	@WithMockUser(username = "Roua_Boussetta", password = "azerty123", authorities = "ADMINISTRATOR")
 	public void testBFindUserActivated() throws Exception {
	...
	@Test
	@WithMockUser(username = "Roua_Boussetta", password = "azerty123", authorities = "ADMINISTRATOR")
 	public void testBFindUserDisabled() throws Exception {
 		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/user/findDeactivatedUser") 
				.accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON);
	...
	*/
	...
	@Test
	@WithMockUser(username = "Roua_Boussetta", password = "azerty123", authorities = "ADMINISTRATOR")
 	public void testBFindCompanyInterns() throws Exception {
 		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/user/company-interns/NawaneraLLC") 
				.accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON);
	...
	@Test
	@WithMockUser(username = "Roua_Boussetta", password = "azerty123", authorities = "ADMINISTRATOR")
 	public void testBFindCompanyHrs() throws Exception {
 		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/user/company-hrs/NawaneraLLC") 
				.accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON);
 ...
 /*
	...
	@WithMockUser(username = "Ahmed_Ahmed", password = "azerty123", authorities = "TRAINER")
 	public void testlockCompanyService() throws Exception {
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.put("/api/user/lock-company-service/2") 
				.accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON);
	...
	@Test
	@WithMockUser(username = "Roua_Boussetta", password = "azerty123", authorities = "ADMINISTRATOR")
 	public void testHLockCompanyService() throws Exception {
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.put("/api/user/lock-company-service/2") 
				.accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON);
	...
	@Test
	@WithMockUser(username = "Roua_Boussetta", password = "azerty123", authorities = "ADMINISTRATOR")
 	public void testHUnLockCompanyService() throws Exception {
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.put("/api/user/unlock-company-service/2") 
				.accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON);
